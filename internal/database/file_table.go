...
type File struct {
	...
	PublishState  int        `gorm:"default:0;index:idx_publish_state;column:publish_state"` // 发布状态：0-未上架，1-已上架，2-已下架
	PublishTime   *time.Time `gorm:"column:publish_time"`
	Price         string     `gorm:"default:'0';column:price"`
	...
	ControllerDID string     `gorm:"unique;index:idx_controller_did;column:controller_did"`
